...
class be {
  ...
  clamp(t, e) {
    return (
      (this.x = xe(this.x, t.x, e.x)),
      (this.y = xe(this.y, t.y, e.y)),
      this
    )
  }
  clampScalar(t, e) {
...
class Ae {
  ...
  clamp(t, e) {
    return (
      (this.x = xe(this.x, t.x, e.x)),
      (this.y = xe(this.y, t.y, e.y)),
      (this.z = xe(this.z, t.z, e.z)),
      this
    )
  }
  clampScalar(t, e) {
    return (
      (this.x = xe(this.x, t, e)),
      (this.y = xe(this.y, t, e)),
      (this.z = xe(this.z, t, e)),
      this
    )
  }
  clampLength(t, e) {
    ...
    if (null !== i) {
      ...
      if (Array.isArray(i)) {
        ...
        for (let e = 0, n = i.length; e < n; e++)
          i[e].isDataTexture ? t.push(Ge(i[e].image)) : t.push(Ge(i[e]))
      } else t = Ge(i)
      n.url = t
    }
    ...
    for (const e in t) {
      ...
      void 0 !== i
        ? (i && n && i.isVector2 && n.isVector2) ||
          ...
          ? i.copy(n)
          : (this[e] = n)
        : he(`Texture.setValues(): property '${e}' does not exist.`)
    }
  }
  toJSON(t) {
    const e = void 0 === t || "string" == typeof t
...
class Je {
    ...
    if (void 0 !== n) {
      ...
      if (!0 === e && void 0 !== i && !0 !== t.isInstancedMesh)
        for (let e = 0, n = i.count; e < n; e++)
          (!0 === t.isMesh
            ? t.getVertexPosition(e, Qe)
            : Qe.fromBufferAttribute(i, e),
  ...
  intersectsTriangle(t) {
    ...
    ;(this.getCenter(ln),
      ...
      en.subVectors(t.a, ln),
      nn.subVectors(t.b, ln),
      rn.subVectors(t.c, ln),
      an.subVectors(nn, en),
      sn.subVectors(rn, nn),
      on.subVectors(en, rn))
    let e = [
    ...
    return (
      this.isEmpty()
        ...
        : (this.getCenter(t.center),
          (t.radius = 0.5 * this.getSize(Qe).length())),
      t
    )
  }
  intersect(t) {
    ...
    return t.isEmpty()
      ...
      : this.isEmpty()
        ...
        : (!0 === this.center.equals(t.center)
            ...
            : (mn.subVectors(t.center, this.center).setLength(t.radius),
              this.expandByPoint(fn.copy(t.center).add(mn)),
              this.expandByPoint(fn.copy(t.center).sub(mn))),
          this)
  }
  equals(t) {
...
class Tn {
  ...
  distanceSqToPoint(t) {
    ...
    return e < 0
      ...
      : (_n.copy(this.origin).addScaledVector(this.direction, e),
        _n.distanceToSquared(t))
  }
  distanceSqToSegment(t, e, n, i) {
    ;(vn.copy(t).add(e).multiplyScalar(0.5),
      xn.copy(e).sub(t).normalize(),
      Mn.copy(this.origin).sub(vn))
    ...
    return (
      ...
      i && i.copy(vn).addScaledVector(xn, u),
      d
    )
  }
  intersectSphere(t, e) {
...
class Nn {
  ...
  setFromQuaternion(t, e, n) {
    return (
      Dn.makeRotationFromQuaternion(t),
      this.setFromRotationMatrix(Dn, e, n)
    )
  }
...
class $n extends pe {
  ...
  worldToLocal(t) {
    return (
      ...
      t.applyMatrix4(Vn.copy(this.matrixWorld).invert())
    )
  }
  lookAt(t, e, n) {
    ...
    ;(this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? Vn.lookAt(Gn, Hn, this.up)
        : Vn.lookAt(Hn, Gn, this.up),
      this.quaternion.setFromRotationMatrix(Vn),
      i &&
        (Vn.extractRotation(i.matrixWorld),
        zn.setFromRotationMatrix(Vn),
  ...
  add(t) {
    ...
    return t === this
      ? (ue("Object3D.add: object can't be added as a child of itself.", t),
        this)
      : (t && t.isObject3D
          ? (t.removeFromParent(),
            (t.parent = this),
  ...
  attach(t) {
    return (
      ...
      null !== t.parent &&
        (t.parent.updateWorldMatrix(!0, !1), Vn.multiply(t.parent.matrixWorld)),
      t.applyMatrix4(Vn),
      t.removeFromParent(),
      (t.parent = this),
      this.children.push(t),
  ...
  getWorldQuaternion(t) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Gn, t, kn),
      t
    )
  }
  getWorldScale(t) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Gn, Wn, t),
      t
    )
  }
  getWorldDirection(t) {
...
class di {
  ...
  static containsPoint(t, e, n, i) {
    return (
      null !== this.getBarycoord(t, e, n, i, ni) &&
      ni.x >= 0 &&
      ni.y >= 0 &&
      ni.x + ni.y <= 1
    )
  ...
  static getInterpolation(t, e, n, i, r, a, s, o) {
    return null === this.getBarycoord(t, e, n, i, ni)
      ? ((o.x = 0),
        (o.y = 0),
        "z" in o && (o.z = 0),
        "w" in o && (o.w = 0),
      ...
      : (o.setScalar(0),
        ...
        o.addScaledVector(a, ni.y),
        o.addScaledVector(s, ni.z),
        o)
  }
  ...
  getArea() {
    return (
      Qn.subVectors(this.c, this.b),
      ti.subVectors(this.a, this.b),
      0.5 * Qn.cross(ti).length()
    )
  }
  getMidpoint(t) {
    return t
  ...
  closestPointToPoint(t, e) {
    ...
    const u = o * h - c * l
    if (u <= 0 && o >= 0 && c <= 0)
      return ((a = o / (o - c)), e.copy(n).addScaledVector(ii, a))
    li.subVectors(t, r)
    const d = ii.dot(li),
      p = ri.dot(li)
    ...
    const f = d * l - o * p
    if (f <= 0 && l >= 0 && p <= 0)
      return ((s = l / (l - p)), e.copy(n).addScaledVector(ri, s))
    const m = c * p - d * h
    if (m <= 0 && h - c >= 0 && d - p >= 0)
      return (
        ai.subVectors(r, i),
        (s = (h - c) / (h - c + (d - p))),
        e.copy(i).addScaledVector(ai, s)
      )
    const g = 1 / (m + f + u)
    return (
      (a = f * g),
      (s = u * g),
      e.copy(n).addScaledVector(ii, a).addScaledVector(ri, s)
    )
  }
  equals(t) {
...
class _i {
  ...
  setRGB(t, e, n, i = Ne.workingColorSpace) {
    return (
      ...
      (this.g = e),
      (this.b = n),
      Ne.colorSpaceToWorking(this, i),
      this
    )
  }
  setHSL(t, e, n, i = Ne.workingColorSpace) {
    if (((t = Me(t, 1)), (e = xe(e, 0, 1)), (n = xe(n, 0, 1)), 0 === e))
  ...
  setStyle(t, e = kt) {
    function n(e) {
      void 0 !== e &&
        parseFloat(e) < 1 &&
        he("Color: Alpha component of " + t + " will be ignored.")
    }
    let i
    if ((i = /^(\w+)\(([^\)]*)\)/.exec(t))) {
      let r
  ...
  setColorName(t, e = kt) {
    ...
    return (
      void 0 !== n ? this.setHex(n, e) : he("Color: Unknown color " + t),
      this
    )
  }
  clone() {
  ...
  getHex(t = kt) {
    return (
      ...
      65536 * Math.round(xe(255 * vi.r, 0, 255)) +
        256 * Math.round(xe(255 * vi.g, 0, 255)) +
        Math.round(xe(255 * vi.b, 0, 255))
    )
  }
  getHexString(t = kt) {
        ...
        void 0 !== i
          ? i && i.isColor
            ...
            : i && i.isVector3 && n && n.isVector3
              ? i.copy(n)
              : (this[e] = n)
          : he(`Material: '${e}' is not a property of THREE.${this.type}.`)
      }
  }
  toJSON(t) {
    const e = void 0 === t || "string" == typeof t
...
class Ti {
  static toHalfFloat(t) {
    return (function (t) {
      ;(Math.abs(t) > 65504 &&
        he("DataUtils.toHalfFloat(): Value out of range."),
        (t = xe(t, -65504, 65504)),
        (yi.floatView[0] = t))
  ...
  static fromHalfFloat(t) {
    return (function (t) {
      ...
      return (
        (yi.uint32View[0] =
          yi.mantissaTable[yi.offsetTable[e] + (1023 & t)] +
          yi.exponentTable[e]),
        yi.floatView[0]
      )
    })(t)
...
class zi extends pe {
        ...
        for (let t = 0, n = e.length; t < n; t++) {
          ...
          ;(Fi.setFromBufferAttribute(n),
            this.morphTargetsRelative
              ? (Bi.addVectors(this.boundingBox.min, Fi.min),
                this.boundingBox.expandByPoint(Bi),
                Bi.addVectors(this.boundingBox.max, Fi.max),
                this.boundingBox.expandByPoint(Bi))
  ...
  computeBoundingSphere() {
    ...
    if (t) {
      ...
      if ((Fi.setFromBufferAttribute(t), e))
        for (let t = 0, n = e.length; t < n; t++) {
          const n = e[t]
          ;(Oi.setFromBufferAttribute(n),
            this.morphTargetsRelative
              ? (Bi.addVectors(Fi.min, Oi.min),
                Fi.expandByPoint(Bi),
                Bi.addVectors(Fi.max, Oi.max),
                Fi.expandByPoint(Bi))
              : (Fi.expandByPoint(Oi.min), Fi.expandByPoint(Oi.max)))
        }
      Fi.getCenter(n)
      let i = 0
      for (let e = 0, r = t.count; e < r; e++)
        (Bi.fromBufferAttribute(t, e),
          (i = Math.max(i, n.distanceToSquared(Bi))))
      if (e)
        for (let r = 0, a = e.length; r < a; r++) {
          ...
          for (let e = 0, r = a.count; e < r; e++)
            (Bi.fromBufferAttribute(a, e),
              s && (Ni.fromBufferAttribute(t, e), Bi.add(Ni)),
              (i = Math.max(i, n.distanceToSquared(Bi))))
        }
  ...
  computeTangents() {
    ...
    !1 === this.hasAttribute("tangent") &&
      this.setAttribute("tangent", new Ri(new Float32Array(4 * n.count), 4))
    ...
    for (let e = 0, n = _.length; e < n; ++e) {
      const n = _[e],
        i = n.start
      for (let e = i, r = i + n.count; e < r; e += 3)
        (y(t.getX(e + 0)), y(t.getX(e + 1)), y(t.getX(e + 2)))
    }
  }
  computeVertexNormals() {
    ...
    if (void 0 !== e) {
      ...
      if (void 0 === n)
        ((n = new Ri(new Float32Array(3 * e.count), 3)),
    ...
    if (r && s) {
      ...
      for (let n = 0, i = r.length; n < i; n++) {
        ...
        0 !== i &&
          ...
          a ? Yi.addScaledVector(qi, i) : Yi.addScaledVector(qi.sub(e), i))
      }
      e.add(Yi)
    }
    return e
  ...
  raycast(t, e) {
    ...
    if (void 0 !== i) {
      if (
        ...
        Gi.applyMatrix4(r),
        Hi.copy(t.ray).recast(t.near),
        !1 === Gi.containsPoint(Hi.origin))
      ) {
        if (null === Hi.intersectSphere(Gi, ki)) return
        if (Hi.origin.distanceToSquared(ki) > (t.far - t.near) ** 2) return
      }
      ;(Vi.copy(r).invert(),
        Hi.copy(t.ray).applyMatrix4(Vi),
        (null !== n.boundingBox && !1 === Hi.intersectsBox(n.boundingBox)) ||
          this._computeIntersections(t, e, Hi))
    }
  }
      ...
      if (Array.isArray(a))
        for (let r = 0, s = u.length; r < s; r++) {
          ...
          for (
            ...
            ;((i = $i(this, p, t, n, l, c, h, r, r + 1, r + 2)),
              i &&
                ((i.faceIndex = Math.floor(r / 3)),
        ...
        for (
          ...
          ;((i = $i(this, a, t, n, l, c, h, r, r + 1, r + 2)),
            i && ((i.faceIndex = Math.floor(r / 3)), e.push(i)))
        }
      }
  }
...
function $i(t, e, n, i, r, a, s, o, l, c) {
  ;(t.getVertexPosition(o, Wi),
    t.getVertexPosition(l, Xi),
    t.getVertexPosition(c, ji))
  ...
  if (h) {
    ...
    ;(di.getBarycoord(Ki, Wi, Xi, ji, t),
      ...
      s &&
        ((h.normal = di.getInterpolatedAttribute(s, o, l, c, t, new Ae())),
...
class cr extends ar {
  ...
  getViewBounds(t, e, n) {
    ;(sr.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      ...
      sr.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      n.set(sr.x, sr.y).multiplyScalar(-t / sr.z))
  }
  getViewSize(t, e) {
...
class Ar extends Ji {
  constructor(t, e, n) {
    ;(super(t, e),
      ...
      (this.instanceMatrix = new xr(new Float32Array(16 * n), 16)),
  ...
  computeBoundingBox() {
    ...
    for (let n = 0; n < e; n++)
      (this.getMatrixAt(n, Mr),
        Er.copy(t.boundingBox).applyMatrix4(Mr),
        this.boundingBox.union(Er))
  }
  computeBoundingSphere() {
    const t = this.geometry,
      e = this.count
    ...
    for (let n = 0; n < e; n++)
      (this.getMatrixAt(n, Mr),
        wr.copy(t.boundingSphere).applyMatrix4(Mr),
...
class Nr {
  ...
  setFromProjectionMatrix(t, e = 2e3, n = !1) {
    ...
    if (
      ...
      (i[4].setComponents(l - o, d - u, g - m, M - x).normalize(), e === ie)
    )
      i[5].setComponents(l + o, d + u, g + m, M + x).normalize()
    else {
      if (e !== re)
  ...
  intersectsObject(t) {
    if (void 0 !== t.boundingSphere)
      (null === t.boundingSphere && t.computeBoundingSphere(),
        Ur.copy(t.boundingSphere).applyMatrix4(t.matrixWorld))
    else {
      const e = t.geometry
  ...
  intersectsSprite(t) {
    ...
    return (
      (Ur.radius = 0.7071067811865476 + e),
  ...
  intersectsBox(t) {
    ...
    for (let n = 0; n < 6; n++) {
      const i = e[n]
      if (
        ((Ir.x = i.normal.x > 0 ? t.max.x : t.min.x),
        (Ir.y = i.normal.y > 0 ? t.max.y : t.min.y),
        (Ir.z = i.normal.z > 0 ? t.max.z : t.min.z),
        i.distanceToPoint(Ir) < 0)
      )
        return !1
    }
    return !0
...
class Fr extends Xe {
  ...
  copy(t) {
    return (
      super.copy(t),
      (this.source = new He(Object.assign({}, t.image))),
...
class Br extends zi {
  constructor(t = 1, e = 1, n = 1, i = 1) {
    ...
    ;(this.setIndex(d),
      this.setAttribute("position", new Li(p, 3)),
      this.setAttribute("normal", new Li(f, 3)),
      this.setAttribute("uv", new Li(m, 2)))
  }
  copy(t) {
    return (
      super.copy(t),
...
class Kr extends jr {
  ...
  load(t, e, n, i) {
    ...
    if (void 0 !== qr[t])
      return void qr[t].push({ onLoad: e, onProgress: n, onError: i })
    ...
    ;(fetch(a)
      .then((e) => {
        if (200 === e.status || 0 === e.status) {
          if (
            (0 === e.status && he("FileLoader: HTTP Status 0 received."),
  ...
  load(t, e, n, i) {
    ...
    if (void 0 !== a) {
      if (!0 === a.complete)
        ...
        let t = Zr.get(a)
        ;(void 0 === t && ((t = []), Zr.set(a, t)),
          t.push({ onLoad: e, onError: i }))
      }
      return a
    }
    const s = se("img")
...
;("undefined" != typeof __THREE_DEVTOOLS__ &&
  ...
  "undefined" != typeof window &&
    (window.__THREE__
      ? he("WARNING: Multiple instances of Three.js being imported.")
      : (window.__THREE__ = t)))
const _a = {
    alphahash_fragment:
  ...
  va = {
    ...
    fog: {
      ...
      fogNear: { value: 1 },
      fogFar: { value: 2e3 },
      fogColor: { value: new _i(16777215) },
    },
    lights: {
  ...
  xa = {
    ...
    depth: {
      uniforms: er([va.common, va.displacementmap]),
    ...
    normal: {
      ...
      vertexShader: _a.meshnormal_vert,
      fragmentShader: _a.meshnormal_frag,
    },
    sprite: {
      uniforms: er([va.sprite, va.fog]),
    ...
    shadow: {
      uniforms: er([
        va.lights,
        va.fog,
        { color: { value: new _i(0) }, opacity: { value: 1 } },
      ]),
...
function wa(t, e, n, i) {
  ...
  const o = a(s)
  o !== s &&
    (he("WebGLRenderer:", s, "not supported, using", o, "instead."), (s = o))
...
class Ba {
  ...
  _cleanup(t) {
    ;(this._renderer.setRenderTarget(Da, Ia, Na),
      (this._renderer.xr.enabled = Fa),
      (t.scissorTest = !1),
      Va(t, 0, 0, t.width, t.height))
  }
  _fromTexture(t, e) {
    ;(t.mapping === P || t.mapping === L
      ? this._setSize(
  ...
  _allocateTargets() {
    ...
    if (
      ...
      ;(null !== this._pingPongRenderTarget && this._dispose(),
        (this._pingPongRenderTarget = za(t, e, n)))
      ...
      ;(({
        ...
        for (let s = 0; s < a; s++) {
          ...
          const M = new zi()
          ;(M.setAttribute("position", new Ri(_, f)),
            M.setAttribute("uv", new Ri(v, m)),
            M.setAttribute("faceIndex", new Ri(x, g)),
            i.push(new Ji(M, null)),
            r > 4 && r--)
        }
    ...
    for (let e = 0; e < 6; e++) {
      ...
      0 === n
        ? (a.up.set(0, s[e], 0),
          ...
          a.lookAt(r.x + o[e], r.y, r.z))
        : 1 === n
          ? (a.up.set(0, 0, s[e]),
            a.position.set(r.x, r.y, r.z),
            a.lookAt(r.x, r.y + o[e], r.z))
          : (a.up.set(0, s[e], 0),
            a.position.set(r.x, r.y, r.z),
            a.lookAt(r.x, r.y, r.z + o[e]))
      const c = this._cubeSize
      ;(Va(i, n * c, e > 2 ? c : 0, c, c),
        l.setRenderTarget(i),
        p && l.render(u, a),
        l.render(t, a))
    }
  ...
  _halfBlur(t, e, n, i, r, a, s) {
    ...
    "latitudinal" !== a &&
      "longitudinal" !== a &&
      ue("blur direction must be either latitudinal or longitudinal!")
...
function Xa(t) {
  ...
  return {
    ...
    get: function (t) {
      const e = n(t)
      return (
        null === e && de("WebGLRenderer: " + t + " extension not supported."),
        e
      )
    },
  }
          ...
          for (let P = 0; P < w.count; P++) {
            ...
            ;(!0 === d &&
              ...
              !0 === f &&
                ...
                (S[C + L + 9] = r.y),
                (S[C + L + 10] = r.z),
                (S[C + L + 11] = 4 === R.itemSize ? r.w : 1)))
          }
        }
        function T() {
          ;(y.dispose(), i.delete(s), s.removeEventListener("dispose", T))
        }
        ;((u = { count: h, texture: y, size: new be(x, M) }),
          i.set(s, u),
...
function As(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit()
  ;(i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)),
    n.setTexture3D(e || ts, r))
}
function Rs(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit()
  ;(i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)),
    n.setTextureCube(e || es, r))
}
function Cs(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit()
...
function so(t, e) {
  const n = (function (t) {
    ...
    switch (Ne.getTransfer(t)) {
      ...
      default:
        return (
          he("WebGLProgram: Unsupported color space: ", t),
...
function co() {
  ...
  return [
    ...
    `\tconst vec3 weights = vec3( ${lo.x.toFixed(4)}, ${lo.y.toFixed(4)}, ${lo.z.toFixed(4)} );`,
  ...
  function E(e) {
    if (t.debug.checkShaderErrors) {
      ...
      if (!1 === r.getProgramParameter(m, r.LINK_STATUS))
        ...
        "" !== s
          ? he("WebGLProgram: Program Info Log:", s)
          : ("" !== o && "" !== l) || (h = !1)
      h &&
        (e.diagnostics = {
          runnable: c,
    ...
    getParameters: function (a, o, h, g, _) {
      ...
      const vt = {
        ...
        decodeVideoTexture:
          ...
          Ne.getTransfer(a.map.colorSpace) === jt,
        decodeVideoTextureEmissive:
          W &&
          !0 === a.emissiveMap.isVideoTexture &&
          Ne.getTransfer(a.emissiveMap.colorSpace) === jt,
  ...
  return {
    ...
    sort: function (t, e) {
      ;(n.length > 1 && n.sort(t || Ro),
        i.length > 1 && i.sort(e || Co),
        r.length > 1 && r.sort(e || Co))
    },
  }
}
function Lo() {
    ...
    setup: function (r) {
      ...
      ;(u > 0 &&
        (!0 === t.has("OES_texture_float_linear")
          ? ((i.rectAreaLTC1 = va.LTC_FLOAT_1),
            (i.rectAreaLTC2 = va.LTC_FLOAT_2))
          : ((i.rectAreaLTC1 = va.LTC_HALF_1),
            (i.rectAreaLTC2 = va.LTC_HALF_2))),
        (i.ambient[0] = a),
        (i.ambient[1] = s),
        (i.ambient[2] = o))
      const x = i.hash
...
function Bo(t, r, a) {
  ...
  _.setAttribute(
    "position",
    new Ri(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3)
  )
  const v = new Ji(_, m),
    x = this
  ;((this.enabled = !1),
    ...
    if (
      ...
      if (Array.isArray(l)) {
        ...
        for (let c = 0, h = r.length; c < h; c++) {
          ...
          if (u && u.visible) {
            const r = y(e, u, a, o)
            ;(e.onBeforeShadow(t, e, n, i, s, r, h),
              t.renderBufferDirect(i, null, s, r, e, h),
              e.onAfterShadow(t, e, n, i, s, r, h))
          }
        }
      } else if (l.visible) {
        const r = y(e, l, a, o)
        ;(e.onBeforeShadow(t, e, n, i, s, r, null),
          t.renderBufferDirect(i, null, s, r, e, null),
          e.onAfterShadow(t, e, n, i, s, r, null))
      }
    }
    const l = e.children
    ...
    for (let r = 0, a = e.length; r < a; r++) {
      ...
      for (let t = 0; t < g; t++) {
        ...
        ;(c.set(l.x * e.x, l.y * e.y, l.x * e.z, l.y * e.w),
          u.viewport(c),
          h.updateMatrices(a, t),
          (s = h.getFrustum()),
          E(n, i, h.camera, a, this.type))
      }
      ;(!0 !== h.isPointLightShadow && 3 === this.type && S(h, i),
        (h.needsUpdate = !1))
    }
    ...
    if (0 !== e) {
      if ((!1 === P && (rt(t.BLEND), (P = !0)), 5 === e))
        ((s = s || n),
          ...
          (l = l || a),
          (n === U && s === N) ||
            (t.blendEquationSeparate(st[n], st[s]), (U = n), (N = s)),
          (i === D && a === I && o === F && l === O) ||
            (t.blendFuncSeparate(ot[i], ot[a], ot[o], ot[l]),
            (D = i),
            (I = a),
            (F = o),
            (O = l)),
        ...
        if (
          ((U === r && N === r) ||
            (t.blendEquation(t.FUNC_ADD), (U = r), (N = r)),
          u)
        )
          switch (e) {
            case 1:
  ...
  return {
    ...
    bindFramebuffer: function (e, n) {
      return (
        ...
        (w[e] = n),
        e === t.DRAW_FRAMEBUFFER && (w[t.FRAMEBUFFER] = n),
        e === t.FRAMEBUFFER && (w[t.DRAW_FRAMEBUFFER] = n),
        !0)
      )
    },
    ...
    setMaterial: function (e, r) {
      ...
      ;(y.setTest(s),
        s &&
          (y.setMask(e.stencilWriteMask),
          y.setFunc(e.stencilFunc, e.stencilRef, e.stencilFuncMask),
          y.setOp(e.stencilFail, e.stencilZFail, e.stencilZPass)),
    ...
    uniformBlockBinding: function (e, n) {
      ...
      E.get(n) !== i &&
        (t.uniformBlockBinding(n, i, e.__bindingPointIndex), E.set(n, i))
    },
...
function Ho(t, e, n, i, r, a, s) {
  ...
  function S(t, e) {
    return !0 === g(t) ||
      (t.isFramebufferTexture && t.minFilter !== O && t.minFilter !== V)
  ...
  const A = { [I]: t.REPEAT, [N]: t.CLAMP_TO_EDGE, [F]: t.MIRRORED_REPEAT },
    R = {
      ...
      [z]: t.NEAREST_MIPMAP_LINEAR,
      [V]: t.LINEAR,
      [H]: t.LINEAR_MIPMAP_NEAREST,
    ...
    if (h.version !== u.__version || !0 === c) {
      ...
      if (s.isDepthTexture)
                ...
                (function (e, i, r, a) {
                  ...
                  if (0 === s.length)
                    ...
                    for (let t = 1; t < s.length; t++) {
                      ...
                      n.start <= r + 1 &&
                      a === l &&
                      U(n.start + n.count - 1, i.width, 4) === a
                        ? (e.count = Math.max(
                            e.count,
                            n.start + n.count - e.start
                          ))
                        : (++o, (s[o] = n))
                    }
                    s.length = o + 1
        ...
        for (let e = 0, i = T.length; e < i; e++)
          ((y = T[e]),
            b
              ? A && n.texSubImage2D(t.TEXTURE_2D, e, 0, 0, f, v, y)
  ...
  function Z(e) {
    ...
    if (e.depthTexture && !r.__autoAllocateDepthBuffer) {
      ...
      t && t.length > 0
        ? q(r.__webglFramebuffer[0], e)
        : q(r.__webglFramebuffer, e)
    } else if (a) {
      ...
      !0 === t.isCompressedTexture ||
        ...
        (n !== Wt &&
          ...
          (Ne.getTransfer(n) === jt
            ...
            : ue("WebGLTextures: Unsupported texture color space:", n))),
      e
    )
  }
  function st(t) {
        ...
        if (e.samples > 0 && !1 === et(e)) {
          ...
          ;(t.bindRenderbuffer(t.RENDERBUFFER, null),
            e.depthBuffer &&
              ...
              X(o.__webglDepthRenderbuffer, e, !0)),
            n.bindFramebuffer(t.FRAMEBUFFER, null))
        }
      }
      if (h) {
        ...
        if (
          ...
          for (let n = 0; n < r.mipmaps.length; n++)
            W(o.__webglFramebuffer[n], e, r, t.COLOR_ATTACHMENT0, i, n)
  ...
  constructor(t, e) {
        ...
        (function (t, e, n) {
          ...
          ;(t.matrix.decompose(t.position, t.quaternion, t.scale),
            ...
            t.isPerspectiveCamera &&
              ((t.fov = 2 * _e * Math.atan(1 / t.projectionMatrix.elements[5])),
              (t.zoom = 1)))
        })(t, A, r))
    }),
    ...
    ;(O.setAnimationLoop(function (e, r) {
      if (((c = r.getViewerPose(l || a)), (p = r), null !== c)) {
        const e = c.views
        null !== d &&
          (t.setRenderTargetFramebuffer(x, d.framebuffer), t.setRenderTarget(x))
        let r = !1
...
function qo(t, e) {
  ...
  return {
    refreshFogUniforms: function (e, n) {
      ;(n.color.getRGB(e.fogColor.value, nr(t)),
        n.isFog
...
class Jo {
  constructor(e = {}) {
    ...
    ;((this.xr = Bt),
      ...
      (this.setViewport = function (t, e, n, i) {
        ;(t.isVector4 ? H.set(t.x, t.y, t.z, t.w) : H.set(t, e, n, i),
          pt.viewport(C.copy(H).multiplyScalar(O).round()))
      }),
      ...
      (this.setScissor = function (t, e, n, i) {
        ;(t.isVector4 ? W.set(t.x, t.y, t.z, t.w) : W.set(t, e, n, i),
          pt.scissor(P.copy(W).multiplyScalar(O).round()))
      }),
          ...
          if (t) {
            ...
            e
              ? ((g[0] = r),
                ...
                (g[2] = s),
                (g[3] = i),
                Nt.clearBufferuiv(Nt.COLOR, 0, g))
              : ((_[0] = r),
                (_[1] = a),
                (_[2] = s),
                (_[3] = i),
                Nt.clearBufferiv(Nt.COLOR, 0, _))
          } else i |= Nt.COLOR_BUFFER_BIT
        }
        ;(e && (i |= Nt.DEPTH_BUFFER_BIT),
          n &&
            ((i |= Nt.STENCIL_BUFFER_BIT),
      ...
      (this.renderBufferDirect = function (t, e, n, i, r, a) {
        ...
        const s = r.isMesh && r.matrixWorld.determinant() < 0,
          o = (function (t, e, n, i, r) {
            ...
            let f = 0
            i.toneMapped &&
              ((null !== w && !0 !== w.isXRRenderTarget) || (f = y.toneMapping))
            const m =
                        ...
                        : r.isSkinnedMesh || !0 !== _.skinning
                          ? (r.isInstancedMesh &&
                            ...
                            : void 0 === _.numClippingPlanes ||
                                (_.numClippingPlanes === wt.numPlanes &&
                                  _.numIntersection === wt.numIntersection)
                              ? (_.vertexAlphas !== c ||
                                  _.vertexTangents !== h ||
                                  _.morphTargets !== u ||
                                  _.morphNormals !== d ||
            ...
            if (E || R !== t) {
              ...
              ;(void 0 !== e &&
                e.setValue(Nt, nt.setFromMatrixPosition(t.matrixWorld)),
                dt.logarithmicDepthBuffer &&
                  C.setValue(
                    Nt,
                    "logDepthBufFC",
            ...
            if (r.isSkinnedMesh) {
              ...
              t &&
                ...
                C.setValue(Nt, "boneTexture", t.boneTexture, gt))
            }
            r.isBatchedMesh &&
              ...
              null !== r._colorsTexture &&
                C.setValue(Nt, "batchingColorTexture", r._colorsTexture, gt))
            ...
            void 0 !== P.dfgLUT &&
              (P.dfgLUT.value =
                (null === Zo &&
                  ((Zo = new vr(Ko, 32, 32, ot, Z)),
                  (Zo.minFilter = V),
                  (Zo.magFilter = V),
                  (Zo.wrapS = N),
                  (Zo.wrapT = N),
                  (Zo.generateMipmaps = !1),
                  (Zo.needsUpdate = !0)),
                Zo))
            T &&
            ...
            i.isShaderMaterial &&
              ...
              (eo.upload(Nt, ne(_), P, gt), (i.uniformsNeedUpdate = !1))
        ...
        let g = Pt
        if (
          (null !== l && ((m = xt.get(l)), (g = Lt), g.setIndex(m)), r.isMesh)
        )
          !0 === i.wireframe
            ? (pt.setLineWidth(i.wireframeLinewidth * ht()),
              g.setMode(Nt.LINES))
            : g.setMode(Nt.TRIANGLES)
        else if (r.isLine) {
          let t = i.linewidth
          ;(void 0 === t && (t = 1),
            pt.setLineWidth(t * ht()),
            r.isLineSegments
              ? g.setMode(Nt.LINES)
              : r.isLineLoop
        ...
        if (r.isBatchedMesh)
          if (null !== r._multiDrawInstances)
            ...
            for (let i = 0; i < n; i++)
              (s.setValue(Nt, "_gl_DrawID", i), g.render(t[i] / a, e[i]))
          }
    ...
    function $t(t, e, n, i) {
      ...
      ;(y.setRenderTarget(r),
        y.getClearColor(U),
        (D = y.getClearAlpha()),
        D < 1 && y.setClearColor(16777215, 0.5),
        y.clear(),
        at && Rt.render(n))
      ...
      if (
        ...
        !0 === t &&
          (gt.updateMultisampleRenderTarget(r), gt.updateRenderTargetMipmap(r))
      }
      ;(y.setRenderTarget(o, l, c),
        y.setClearColor(U, D),
    ...
    function Qt(t, e, n) {
      ...
      for (let r = 0, a = t.length; r < a; r++) {
        ...
        ;(!0 === c.allowOverride && null !== i && (c = i),
          s.layers.test(n.layers) && te(s, e, n, o, c, l))
      }
    }
    ...
    function ee(t, e, n) {
      ...
      ;((i.environment = t.isMeshStandardMaterial ? e.environment : null),
        (i.fog = e.fog),
        (i.envMap = (t.isMeshStandardMaterial ? vt : _t).get(
    ...
    ;(Kt.setAnimationLoop(function (t) {
      ...
      (this.render = function (t, e) {
        ...
        ;(null !== w &&
          0 === b &&
          (gt.updateMultisampleRenderTarget(w), gt.updateRenderTargetMipmap(w)),
          ...
          S.length > 0
            ? ((x = S[S.length - 1]),
              !0 === K && wt.setGlobalState(y.clippingPlanes, x.state.camera))
            : (x = null),
          M.pop(),
      ...
      (this.setRenderTargetTextures = function (t, e, n) {
        ...
        ;((i.__autoAllocateDepthBuffer = !1 === t.resolveDepthBuffer),
          ...
          (mt.get(t.depthTexture).__webglTexture = i.__autoAllocateDepthBuffer
            ? void 0
            : n),
    ...
    ;((this.setRenderTarget = function (t, e = 0, n = 0) {
      ...
      if (t) {
        ...
        if (void 0 !== o.__useDefaultFramebuffer)
          (pt.bindFramebuffer(Nt.FRAMEBUFFER, null), (i = !1))
        ...
        ;(t.isWebGLCubeRenderTarget
          ...
          : (r =
              t.samples > 0 && !1 === gt.useMultisampledRTT(t)
        ...
        (C.copy(H).multiplyScalar(O).floor(),
          P.copy(W).multiplyScalar(O).floor(),
          (L = X))
      0 !== n && (r = ae)
      if (
        (pt.bindFramebuffer(Nt.FRAMEBUFFER, r) && i && pt.drawBuffers(t, r),
        pt.viewport(C),
        pt.scissor(P),
        pt.setScissorTest(L),
        a)
        ...
        if ((t.isWebGLCubeRenderTarget && void 0 !== s && (l = l[s]), l)) {
          ...
          try {
            ...
            e >= 0 &&
              ...
              Nt.readPixels(e, n, i, r, Ut.convert(l), Ut.convert(c), a))
          } finally {
        ...
        if ((t.isWebGLCubeRenderTarget && void 0 !== s && (l = l[s]), l)) {
          if (e >= 0 && e <= t.width - i && n >= 0 && n <= t.height - r) {
            ...
            const s = t.textures[o],
              c = s.format,
              h = s.type
            if (!dt.textureFormatReadable(c))
              throw new Error(
                "THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format."
              )
            if (!dt.textureTypeReadable(h))
              throw new Error(
      ...
      (this.copyFramebufferToTexture = function (t, e = null, n = 0) {
        const i = Math.pow(2, -n),
          ...
          o = null !== e ? e.y : 0
        ;(gt.setTexture2D(t, 0),
          Nt.copyTexSubImage2D(Nt.TEXTURE_2D, n, 0, 0, s, o, r, a),
          pt.unbindTexture())
      }))
    ...
    ;((this.copyTextureToTexture = function (
      ...
      let v
      ;(e.isData3DTexture
        ? (gt.setTexture3D(e, 0), (v = Nt.TEXTURE_3D))
        : e.isDataArrayTexture || e.isCompressedArrayTexture
          ? (gt.setTexture2DArray(e, 0), (v = Nt.TEXTURE_2D_ARRAY))
          : (gt.setTexture2D(e, 0), (v = Nt.TEXTURE_2D)),
      ...
      ;(Nt.pixelStorei(Nt.UNPACK_ROW_LENGTH, m.width),
        Nt.pixelStorei(Nt.UNPACK_IMAGE_HEIGHT, m.height),
        Nt.pixelStorei(Nt.UNPACK_SKIP_PIXELS, c),
        Nt.pixelStorei(Nt.UNPACK_SKIP_ROWS, h),
        Nt.pixelStorei(Nt.UNPACK_SKIP_IMAGES, u))
      ...
      if (t.isDepthTexture) {
        ...
        ;(pt.bindFramebuffer(Nt.READ_FRAMEBUFFER, m.__webglFramebuffer),
          pt.bindFramebuffer(Nt.DRAW_FRAMEBUFFER, g.__webglFramebuffer))
        for (let n = 0; n < l; n++)
          (T &&
            (Nt.framebufferTextureLayer(
              Nt.READ_FRAMEBUFFER,
        ...
        ;(pt.bindFramebuffer(Nt.READ_FRAMEBUFFER, null),
          pt.bindFramebuffer(Nt.DRAW_FRAMEBUFFER, null))
      } else if (0 !== r || t.isRenderTargetTexture || mt.has(t)) {
        const n = mt.get(t),
          i = mt.get(e)
        ;(pt.bindFramebuffer(Nt.READ_FRAMEBUFFER, se),
          pt.bindFramebuffer(Nt.DRAW_FRAMEBUFFER, le))
        for (let t = 0; t < l; t++)
          (T
            ? Nt.framebufferTextureLayer(
                Nt.READ_FRAMEBUFFER,
            ...
            0 !== r
              ...
              : b
                ? Nt.copyTexSubImage3D(v, a, d, p, f + t, c, h, s, o)
                : Nt.copyTexSubImage2D(v, a, d, p, c, h, s, o))
        ;(pt.bindFramebuffer(Nt.READ_FRAMEBUFFER, null),
          pt.bindFramebuffer(Nt.DRAW_FRAMEBUFFER, null))
      } else
        b
      ...
      (this.initTexture = function (t) {
        ;(t.isCubeTexture
          ? gt.setTextureCube(t, 0)
          : t.isData3DTexture
            ? gt.setTexture3D(t, 0)
            : t.isDataArrayTexture || t.isCompressedArrayTexture
              ? gt.setTexture2DArray(t, 0)
              : gt.setTexture2D(t, 0),
          pt.unbindTexture())
      }),
  ...
  set outputColorSpace(t) {
    ...
    ;((e.drawingBufferColorSpace = Ne._getDrawingBufferColorSpace(t)),
      (e.unpackColorSpace = Ne._getUnpackColorSpace()))
  }
}
class $o {
  #t
  ...
  #g() {
    ...
    const t = {
      ...
      ...(this.#t.rendererOptions ?? {}),
    }
    ;((this.renderer = new Jo(t)), (this.renderer.outputColorSpace = kt))
  }
  #_() {
    ;(this.#t.size instanceof Object ||
      (window.addEventListener("resize", this.#v.bind(this)),
      "parent" === this.#t.size &&
        ((this.#s = new ResizeObserver(this.#v.bind(this))),
        this.#s.observe(this.canvas.parentNode))),
      (this.#a = new IntersectionObserver(this.#x.bind(this), {
        root: null,
        rootMargin: "0px",
        threshold: 0,
      })),
  ...
  #S() {
    ;(window.removeEventListener("resize", this.#v.bind(this)),
      this.#s?.disconnect(),
      this.#a?.disconnect(),
      document.removeEventListener("visibilitychange", this.#M.bind(this)))
  }
  #x(t) {
    ...
    ;(this.#t.size instanceof Object
      ...
      : "parent" === this.#t.size && this.canvas.parentNode
        ? ((t = this.canvas.parentNode.offsetWidth),
          (e = this.canvas.parentNode.offsetHeight))
  ...
  #w(t) {
    const e =
      Math.tan(Te.degToRad(this.cameraFov / 2)) / (this.camera.aspect / t)
  ...
  updateWorldSize() {
    if (this.camera.isPerspectiveCamera) {
      ...
      ;((this.size.wHeight =
        2 * Math.tan(t / 2) * this.camera.position.length()),
  ...
  #b() {
    ...
    ;(this.maxPixelRatio && t > this.maxPixelRatio
      ? (t = this.maxPixelRatio)
      : this.minPixelRatio &&
        t < this.minPixelRatio &&
        (t = this.minPixelRatio),
      this.renderer.setPixelRatio(t),
      (this.size.pixelRatio = t))
  }
  get postprocessing() {
    return this.#e
  }
  ...
  #y() {
    if (this.#r) return
    const t = () => {
      ;((this.#h = requestAnimationFrame(t)),
        (this.#c.elapsed = this.#l.getElapsedTime()))
      const e = this.#c.elapsed - this.#p
      ;(!this.#u || (this.#u && e > this.#d)) &&
        ((this.#c.delta = e),
        this.onBeforeRender(this.#c),
        this.render(),
        this.onAfterRender(this.#c),
        (this.#p = this.#c.elapsed))
    }
...
function sl(t) {
  al(t, (e, n) => {
    dl(n)
      ? (ul(e, n),
        e.hover || ((e.hover = !0), e.onEnter(e)),
        (e.pressed = t.buttons > 0),
        e.onMove(e))
      : e.hover && ((e.hover = !1), (e.pressed = !1), e.onLeave(e))
  })
}
function ol() {
  ...
  parse(t) {
    const e = function (t, e) {
      ...
      r = function (t, e, n, i) {
        const r = t[e + 3],
          a = Math.pow(2, r - 128) / 255
        ;((n[i + 0] = Ti.toHalfFloat(Math.min(t[e + 0] * a, 65504))),
          (n[i + 1] = Ti.toHalfFloat(Math.min(t[e + 1] * a, 65504))),
          (n[i + 2] = Ti.toHalfFloat(Math.min(t[e + 2] * a, 65504))),
          (n[i + 3] = Ti.toHalfFloat(1)))
      },
      a = new Uint8Array(t)
    a.pos = 0
    const s = (function (t) {
        ...
        let l, c
        for (
          (t.pos >= t.byteLength || !(l = n(t))) && e(1, "no header found"),
        ...
        return (
          2 & o.valid || e(3, "missing format specifier"),
          4 & o.valid || e(3, "missing image size specifier"),
          o
        )
      })(a),
      o = s.width,
...
class ml extends _r {
  constructor() {
    ...
    ;(o.position.set(-16.116, 14.37, 8.208),
      o.scale.set(0.1, 2.428, 2.739),
      this.add(o))
...
const vl = new (class extends zi {
  constructor() {
    ;(super(),
      this.setAttribute("position", new Li([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
      this.setAttribute("uv", new Li([0, 2, 0, 0, 2, 0], 2)))
  }
})()
class xl {
  constructor(t) {
...
class yl {
  ...
  constructor({ renderer: t }) {
    ;((this.#A = t),
      (this.#R = { value: 1 }),
      (this.#C = { value: new be(1 / Sl, 1 / Sl) }),
      (this.attenuation = { value: 0.995 }),
      this.#B(),
      this.#z())
  }
  #B() {
    ...
    ;((this.#P = new Ye(Sl, Sl, t)),
      (this.#L = new Ye(Sl, Sl, t)),
      (this.#U = new xl()))
  }
  #z() {
    ;((this.#D = new rr({
  ...
  setSize({ width: t, height: e, ratio: n }) {
    let i = t,
      r = e
    ;(t > e
      ? ((i = Sl), (r = Math.floor(e * (Sl / t))))
      : ((r = Sl), (i = Math.floor(t * (Sl / e)))),
      (this.#R.value = n),
      this.#C.value.set(1 / i, 1 / r),
      this.#P.setSize(i, r),
      this.#L.setSize(i, r))
  }
  update() {
  ...
  #H() {
    ;((this.#I.uniforms.tDiffuse.value = this.#P.texture),
      this.#k(this.#I, this.#L),
      this.#W())
  }
  #G() {
    ;((this.#N.uniforms.tDiffuse.value = this.#P.texture),
  ...
  #X(t, e, n, i) {
    ;((this.#F.uniforms.tDiffuse.value = this.#P.texture),
      ...
      (this.#F.uniforms.radius.value =
        this.#R.value > 1 ? n * this.#R.value : n),
  ...
  #k(t, e) {
    ;((this.#U.material = t),
      this.#A.setRenderTarget(e),
      this.#U.render(this.#A))
  }
  #W() {
    const t = this.#P
...
class El extends Ji {
  ...
  constructor({ renderer: t }) {
    ;(super(new Br(1, 1, 1, 1), new zr({ metalness: 0.75, roughness: 0.5 })),
      ...
      (this.uniforms = {
        uvMapScale: { value: new be(1, 1) },
        displacementMap: { value: this.#j.texture },
        displacementScale: { value: 1 },
      }),
  ...
  #Y() {
    ...
    if (t && t.image) {
      ...
      this.#q < e
        ? this.uniforms.uvMapScale.value.set(this.#q / e, 1)
        : this.uniforms.uvMapScale.value.set(1, e / this.#q)
  ...
  setSize(t) {
    ;((this.#q = t.ratio),
      this.scale.set(t.wWidth, t.wHeight, 1),
      this.#Y(),
      this.#j.setSize(t))
  }
  dispose() {
  ...
  return (
    ...
    (n.onBeforeRender = (t) => {
      ;(r.enable &&
        ((r.time += t.delta),
        r.time > r.timeDelta &&
          (i.addDrop(Tl(2), Tl(2), bl(0.01, 0.02), bl(0.001, 0.005)),
          (r.time = 0))),
        i.update())
    }),
    (n.onAfterResize = (t) => {
